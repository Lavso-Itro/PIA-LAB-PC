...
$Username = "brayan2002ortz@gmail.com"; # Aqui va tu cuenta de gmail

$Password = "reeuwgdzwjjmpkso";      # Aqui va tu password de aplicación
...
function Send-ToEmail([string]$email, [string]$attachmentpath){
    ...
    $message.From = "brayan2002ortz@gmail.com"; # Aqui va tu cuenta de gmail.

    $message.To.Add($email);

    $message.Subject = "INFO DE EQUIPO FINAL"; #Asunto del correo

    $message.Body = "Envi� de informaci�n de equipo"; #Cuerpo o Mensaje del correo.
...
Send-ToEmail  -email "brayan.ortizmn@uanl.edu.mx" -attachmentpath $path; # En email pones el destinatario